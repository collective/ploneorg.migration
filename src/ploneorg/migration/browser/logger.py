...
from ploneorg.migration.browser.catalogsource import VALIDATIONKEY
from ploneorg.migration.browser.catalogsource import ERROREDKEY
from ploneorg.migration.browser.catalogsource import COUNTKEY
